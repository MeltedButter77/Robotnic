...
async def update_temp_channel_names(bot):
    ...
    while not bot.is_closed():  # Run on a schedule
        try:
            ...
            temp_channel_ids = bot.repos.temp_channels.get_temp_channel_ids()
        ...
        try:
            ...
            for channel_id in temp_channel_ids:
                ...
                if channel is None:
                    ...
                    bot.repos.temp_channels.remove_temp_channel(channel_id)
                    continue
                ...
                if len(channel.members) == 0:
                    ...
                    bot.repos.temp_channels.remove_temp_channel(channel.id)
