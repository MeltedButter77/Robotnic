...
class ChangeNameModal(discord.ui.Modal):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        profanity_check_setting = self.bot.repos.guild_settings.get_guild_profanity_filter(interaction.guild.id)["profanity_filter"]
        ...
        if self.channel_name.value:
            ...
            self.bot.repos.temp_channels.set_temp_channel_is_renamed(self.channel.id, True)
        else:
            # If left blank the channel rename override is reset
            self.bot.repos.temp_channels.set_temp_channel_is_renamed(self.channel.id, False)
