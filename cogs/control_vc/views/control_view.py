...
class ControlView(View):
    ...
    def create_items(self):
        channel_state = self.bot.repos.temp_channels.get_temp_channel_info(self.temp_channel.id).channel_state
        ...
        guild_settings = self.bot.repos.guild_settings.get_guild_settings(self.temp_channel.guild.id)
    ...
    async def delete_button_callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            self.bot.repos.temp_channels.remove_temp_channel(interaction.channel.id)
