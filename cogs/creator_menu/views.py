...
class CreateView(View):
    ...
    def create_items(self, guild=None):
        ...
        # Dropdown (own row)
        options = []
        creator_channel_ids = self.bot.repos.creator_channels.get_creator_channel_ids(guild_id=guild.id)
    ...
    async def button_callback(self, interaction: discord.Interaction):
        ...
        self.bot.repos.creator_channels.add_creator_channel(new_creator_channel.guild.id, new_creator_channel.id, "{user}'s Room", 0, 0, 1)
